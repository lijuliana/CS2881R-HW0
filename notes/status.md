...
| 8 | protection dissociation (causal) | do internal lesions hurt parallel storage more than serial chains | var arm complete (lesion does not hurt chains); entity arm running | 60% |
